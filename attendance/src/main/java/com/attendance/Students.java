...
public class Students {
    ...
    public void studentView() throws SQLException {
        ...
        user.setFont(text);
        user.setBounds(25, 80, 150, 20);
        user.setForeground(Color.decode("#DEE4E7"));
        frame.add(user);
        final JTextField username = new JTextField();
        username.setBounds(25, 120, 400, 35);
        ...
        nm.setFont(text);
        nm.setBounds(25, 160, 150, 20);
        nm.setForeground(Color.decode("#DEE4E7"));
        frame.add(nm);
        final JTextField name = new JTextField();
        name.setBounds(25, 190, 400, 35);
        ...
        pass.setFont(text);
        pass.setBounds(25, 240, 150, 20);
        pass.setForeground(Color.decode("#DEE4E7"));
        frame.add(pass);
        final JTextField password = new JTextField();
        password.setBounds(25, 270, 400, 35);
        ...
        // -----------------------------------------------------------
        // --------------------PHONE NUMBER-------------------------
        JLabel phoneLabel = new JLabel("PHONE N0 : ");
        phoneLabel.setFont(text);
        phoneLabel.setBounds(25, 320, 150, 20);
        phoneLabel.setForeground(Color.decode("#DEE4E7"));
        frame.add(phoneLabel);

        final JTextField phoneNumberField = new JTextField();
        phoneNumberField.setBounds(25, 350, 400, 35);
        phoneNumberField.setBackground(Color.decode("#DEE4E7"));
        phoneNumberField.setFont(text);
        phoneNumberField.setForeground(Color.decode("#37474F"));
        phoneNumberField.setEditable(true); // Set editable to true
                ...
                if (check == 1) {
                    try {
                        adder(Integer.parseInt(idbox.getText()), username.getText(), name.getText(), password.getText(),
                                String.valueOf(clss.getSelectedItem()), phoneNumberField.getText());
    ...
    public void adder(int id, String user, String name, String password, String classes, String phoneNumber)
            throws SQLException {
        String adding = "insert into user values (" + id + ", '" + user + "', '" + name + "', '" + password + "', 3)";
        String adding2 = "insert into students values (" + id + ", '" + name + "', '" + classes + "', '" + phoneNumber
                + "')";
        Statement stm = con.createStatement();
